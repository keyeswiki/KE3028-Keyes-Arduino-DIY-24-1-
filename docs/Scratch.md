...
![](media/8d29afb5d9d2286d5c99345a35ef6afc.png)![](media/d6d52424c2525b72aea53b8e7e9d59e3.png)
...
![](media/61441fea9b6204535143316bd97769d2.png)

代码说明

1.首先添加扩展四位数码管模块![](media/2b12331344154693b501d60c0cdc1b30.png)我们这里CLK管脚接模拟口SCL，DIO管脚接模拟口SDA，使用扩展库时自动默认IIC接口，我们可以不用管它。

2\.
找到![](media/d10b3bbaba643b887dcfb1b59417347c.png)，这个用于显示数字或者字符串，我们前面定义一个整数变量item，我们这里让数码管显示这个变量的值![](media/c6eb35bc7298702cd76ea79cd73e03eb.png)。

4.![](media/cae1e45e58fff1bdae59dca05eafef15.png)变量每100ms加1，直到变量item大于9999又从0开始。
...
在上一课实验中，我们利用避障传感器检测障碍物进行报警，在这一实验中，我们利用人体红外热释传感器检测结果控制一个有源蜂鸣器响起。
...
上传测试代码成功，上电后，滑动模块电位器，就可以调节LED模块上的LED的亮度，并且在串口监视器上可以看到左边的模拟值对应右边的PWM值。
...
![](media/1d2fd47fd8881d582db3d41c99936f8e.png)
...
![](media/1b464d04be0d22671a3fe9c6109ef023.png)
...
![](media/df103a8da1ea89067e8011a341c21c4d.png)

代码说明

1.  注意：我们上传代码时![](media/cdf2a624e21f0668b89dbb14bc60d9d5.png)，请选择我们前面说过的方法2，从电脑中上传，代码块较多时，需要多上传几次。

2.  设置时，我们参考本章节实验三十方法。计算出按下按键的次数，除以5，得到余数，为0     1 2 3     4，根据不同的余数，构造5个独一的函数![](media/f064f3e921891b01e899790f73be8f01.png)来控制实验实现不同功能，构造函数时![](media/ae4b3e10673c490b40b539ab5530d9e5.png)输入函数名即可。

3.  参照介绍方法，我们可以在接线中添加或减少传感器/模块，然后在代码中更改实验功能。

测试结果

![](media/d2abd223002f3ba3341f7b395c7ca3d1.png)
